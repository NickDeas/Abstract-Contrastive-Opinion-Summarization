...
if __name__ == '__main__':
	...
	parser_zs.add_argument('-bs', '--batch-size', type = int, help = 'Batch size for training and testing')
	...
	parser_fs.add_argument('-bs', '--batch-size', type = int, help = 'Batch size for training and testing')
	...
	if sc_name == 'zshot':
		...
		run_zero_shot(model_type, model_chkpt, test_fp, chkpt_dir = chkpt_dir)
		...
		run_few_shot(model_type, model_chkpt, data_srcs, chkpt_dir = chkpt_dir)
